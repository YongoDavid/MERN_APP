...
export const fetchStoreCategories = () => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${REACT_APP_API_URL}/category/list`);
...
export const fetchCategories = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(`${REACT_APP_API_URL}/category`);
...
export const fetchCategory = id => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${REACT_APP_API_URL}/category/${id}`);
...
export const addCategory = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.post(`${REACT_APP_API_URL}/category/add`, newCategory);
...
export const updateCategory = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(`${REACT_APP_API_URL}/category/${category._id}`, {
...
export const activateCategory = (id, value) => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.put(`${REACT_APP_API_URL}/category/${id}/active`, {
        category: {
          isActive: value
        }
      });
...
export const deleteCategory = id => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.delete(`${REACT_APP_API_URL}/category/delete/${id}`);
