...
export const fetchStoreBrands = () => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${REACT_APP_API_URL}/brand/list`);
...
export const fetchBrands = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(`${REACT_APP_API_URL}/brand`);
...
export const fetchBrand = brandId => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${REACT_APP_API_URL}/brand/${brandId}`);
...
export const fetchBrandsSelect = () => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${REACT_APP_API_URL}/brand/list/select`);
...
export const addBrand = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.post(`${REACT_APP_API_URL}/brand/add`, brand);
...
export const updateBrand = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(`${REACT_APP_API_URL}/brand/${brand._id}`, {
        brand: newBrand
      });
...
export const activateBrand = (id, value) => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.put(`${REACT_APP_API_URL}/brand/${id}/active`, {
        brand: {
          isActive: value
        }
      });
...
export const deleteBrand = id => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.delete(`${REACT_APP_API_URL}/brand/delete/${id}`);
